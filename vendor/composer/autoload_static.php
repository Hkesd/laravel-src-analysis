...
class ComposerStaticInit901467e07f0d9f8849360bc08fc4ebe6
{
    ...
    {
        // 把类中的顶级命名空间复制给ClassLoader类
        // 注意Closure::bind的使用 https://php.net/manual/zh/closure.bind.php

        // 返回一个匿名函数，因为ClassLoader中的prefixLengthsPsr4、prefixDirsPsr4等是私有变量，利用bind函数
        // 最后一个参数绑定类的作用域。类作用域用来决定闭包中$this对象的私有、保护方法的可见性

        return \Closure::bind(function () use ($loader) {

            // PSR4 规范 https://learnku.com/laravel/t/2081/psr-specification-psr-4-automatic-loading-specification

            // PSR4 标准顶级命名空间映射数组
            // $prefixLengthsPsr4 前缀索引 存储的是顶级命名空间长度
            // 为什么要存储顶级命名空间长度？ 因为PSR4标准是用顶级命名空间目录替换顶级命名空间，所以获取顶级命名空间的长度很重要（现在已经不这么干了）
            $loader->prefixLengthsPsr4 = ComposerStaticInit901467e07f0d9f8849360bc08fc4ebe6::$prefixLengthsPsr4;
            // 顶级命名空间映射的目录数组（映射目录可能不止一条，所以是数组）
            $loader->prefixDirsPsr4 = ComposerStaticInit901467e07f0d9f8849360bc08fc4ebe6::$prefixDirsPsr4;
            /**
             * ------------------------------------------------------------------------
             * 例子说明这两个数组有何作用
             *
             * 假如我们找phpDocumentor\\Reflection\\test 这个命名空间
             *
             * 1. 通过$prefixLengthsPsr4前缀索引以及字符串匹配得到，key是顶级命名空间，value是命名空间长度
             *    'phpDocumentor\\Reflection\\' => 25,
             *
             * 2. 拿顶级命名空间去$prefixDirsPsr4获取它的映射目录数组
             *     'phpDocumentor\\Reflection\\' =>
                    array (
                        0 => __DIR__ . '/..' . '/phpdocumentor/reflection-common/src',
                        1 => __DIR__ . '/..' . '/phpdocumentor/type-resolver/src',
             ...
             * 3. 将命名空间phpDocumentor\\Reflection\\test的前25个字符替换成$prefixDirsPsr4的目录数组中的第一个
             * 4. 得到__DIR__ . '/..' . '/phpdocumentor/reflection-common/src/test.php' 验证磁盘是否存在该文件
             * 5. 如果不存在继续遍历目录数组，如果遍历到最后一个都没找到，则加载失败
             *
             * ------------------------------------------------------------------------
             */

            // PSR0 标准 现该标准已近废弃
            $loader->prefixesPsr0 = ComposerStaticInit901467e07f0d9f8849360bc08fc4ebe6::$prefixesPsr0;

            // 直接命名空间全名与目录的映射，简单粗暴
            $loader->classMap = ComposerStaticInit901467e07f0d9f8849360bc08fc4ebe6::$classMap;
